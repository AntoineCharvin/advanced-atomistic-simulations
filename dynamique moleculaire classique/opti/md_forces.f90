...
10  continue
 ...
 integer :: i , j
 ! D é claration tableau temporaire
 ...
 ! Optimisation calcul des distances avec tableau temporaire
 ri = pos (: , i )
...
program main
  ...
  integer              :: unit_inp=100, unit_log=101
  ...
  call forces(rcut,box,pos,for,epot)
  do i = 1,nsteps
     call evolve(dt,rcut,box,pos,vel,for,epot)
